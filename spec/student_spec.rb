...
describe 'School' do
  ...
  describe "#add_student" do
    ...
    it 'is able to add students to different grades' do
      ...
      expect(@school.roster).to eq({10 => ["AC Slater", "Jeff Baird", "Blake Johnson", "Avi Flombaum"], 9=>["Homer Simpson"]})
    end
  end
  ...
  describe "#sort" do
    it 'is able to sort the students' do
      ...
      expect(@school.sort).to eq([[7, ["Blake Johnson", "Jack Bauer"]], [9, ["Homer Simpson", "Bart Simpson"]], [10, ["AC Slater", "Jeff Baird", "Blake Johnson", "Avi Flombaum"]]])
    end
  end
end
