...
describe 'School' do
  ...
  describe "#add_student" do
    ...
    it 'is able to add multiple students to a class (grade)' do
      ...
      expect(@school.roster).to eq({7 => [], 9 => [], 10 => ["AC Slater", "Jeff Baird"]})
    end
    ...
    it 'is able to add students to different grades' do
      ...
      expect(@school.roster).to eq({7 => ["Blake Johnson"], 9 => ["Homer Simpson"], 10 => ["AC Slater", "Avi Flombaum", "Jeff Baird"]})
    end
  end
  ...
  describe "#sort" do
    it 'is able to sort the students' do
      ...
      expect(@school.sort).to eq({7 => ["Blake Johnson", "Jack Bauer"], 9 => ["Bart Simpson", "Homer Simpson"], 10 => ["AC Slater", "Avi Flombaum", "Jeff Baird"]})
    end
  end
end
